...
import static id.govca.jetpackassignment.data.source.remote.StatusResponse.EMPTY;
import static id.govca.jetpackassignment.data.source.remote.StatusResponse.ERROR;
import static id.govca.jetpackassignment.data.source.remote.StatusResponse.SUCCESS;
